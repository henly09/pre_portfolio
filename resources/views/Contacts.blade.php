...
<p class="head-title1">Contact Me:</p>
	<p class="description"> 
		...
		these images below. (click the icons for the link of my social media accounts)	
	</p>
...
<center>	
	...
	<center>
		<form action="/action_page.php">
  		<textarea id="fname" rows="10" cols="30"></textarea>
	</form>
	</center>
	</div>
	<center>
		<div class="button">	
			<a href="#"> <input href="#" id="nick" type="submit"> </a>
		</div>
	</center>
</body>
	</div>
<li class="trans2"> <img src="{{ asset('Images/b.jpg') }}" width="20px"> </li>
<footer>
<center>
<li class="trans2"> </li>
